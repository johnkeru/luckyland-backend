            ...
            <div class="reservation-info">
                ...
                <ul>
                    @foreach ($data['roomsNeedStock'] as $room)
                        <li>Room: {{ $room['room_name'] }}, Item: {{ $room['item_name'] }}, Quantity Needed:
                            {{ $room['quantity_need'] }}</li>
                    @endforeach
                </ul>
            </div>
        @endif
            ...
            <div class="reservation-info">
                ...
                <ul>
                    @foreach ($data['cottagesNeedStock'] as $cottage)
                        <li>Cottage: {{ $cottage['cottage_name'] }}, Item: {{ $cottage['item_name'] }}, Quantity Needed:
                            {{ $cottage['quantity_need'] }}</li>
                    @endforeach
                </ul>
            </div>
        @endif

        @if (!empty($data['othersNeedStock']))
            <div class="reservation-info">
                <p><strong>Others Needing Stock:</strong></p>
                <ul>
                    @foreach ($data['othersNeedStock'] as $other)
                        <li>Other: {{ $other['other_name'] }}, Item: {{ $other['item_name'] }}, Quantity Needed:
                            {{ $other['quantity_need'] }}</li>
                    @endforeach
                </ul>
            </div>
        @endif
